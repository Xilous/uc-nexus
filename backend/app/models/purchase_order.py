...
from sqlalchemy import String, Integer, Numeric, Date, Index, ForeignKey, Enum, CheckConstraint
from sqlalchemy.orm import Mapped, mapped_column, relationship

from . import Base
from .enums import POStatus, Classification
...
class PurchaseOrder(Base):
    ...
    status: Mapped[POStatus] = mapped_column(
        Enum(POStatus, name="po_status", create_constraint=True), nullable=False
    )
