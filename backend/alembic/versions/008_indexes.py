...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_hardware_items_project_cat_code", "hardware_items", ["project_id", "hardware_category", "product_code"]
    )
    ...
    op.create_index(
        "ix_shop_assembly_opening_items_opening", "shop_assembly_opening_items", ["shop_assembly_opening_id"]
    )
