...
def upgrade() -> None:
    ...
    op.create_check_constraint(
        "ck_receive_line_items_quantity_received_positive", "receive_line_items", "quantity_received >= 1"
    )
    ...
    op.create_check_constraint(
        "ck_pull_request_items_requested_quantity_positive", "pull_request_items", "requested_quantity >= 1"
    )
    op.create_check_constraint(
        "ck_shop_assembly_opening_items_quantity_positive", "shop_assembly_opening_items", "quantity >= 1"
    )
