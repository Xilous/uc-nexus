...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('shop_assembly_request_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('shop_assembly_requests.id'), nullable=False),
        sa.Column('opening_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('openings.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('shop_assembly_opening_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('shop_assembly_openings.id'), nullable=False),
        sa.Column('hardware_category', sa.String(), nullable=False),
        sa.Column('product_code', sa.String(), nullable=False),
        sa.Column('quantity', sa.Integer(), nullable=False),
    )
